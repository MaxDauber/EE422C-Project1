...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        v = 2;
        System.out.println("x[] = " + Arrays.toString(x) + ", v = "+ v + ", n = "+ n);
        System.out.println("Correct output: [2, 2, 2, 2, 2], Your output: " + Arrays.toString(SortTools.insertGeneral(x,n,v)));
        x = new int[]{-1, 2, 3, 3};
        n = 4;
        v = 4;
        System.out.println("x[] = " + Arrays.toString(x) + ", v = "+ v + ", n = "+ n);
        System.out.println("Correct output: [-1, 2, 3, 3, 4], Your output: " + Arrays.toString(SortTools.insertGeneral(x,n,v)));
        v = 5;
        n = 3;
        System.out.println("x[] = " + Arrays.toString(x) + ", v = "+ v + ", n = "+ n);
        System.out.println("Correct output: [-1, 2, 3, 5], Your output: " + Arrays.toString(SortTools.insertGeneral(x,n,v)));
